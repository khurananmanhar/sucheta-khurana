        ...
        return (
            <div className="container">
                ...
                <div className="imageContainer">
                    <img src={information.image[0]} alt="Yellow and white background about Soji Practice and graphic of a monk" />
                    <img src={information.image[1]} alt="Yellow background and white stars that reads Concious Cleaning and states Dhyana Cleanings mission " />
                    <img src={information.image[2]} alt="Brown and white background with and a graphic of someone using a spray bottle. Also shows 5 star comments about Dhyana Cleaning" />
                </div>
